...
function getMarketBuyPrice(cubesInMarket) {
  ...
  // Buying removes from the cheapest filled slot (top of track)
  // 8 cubes: cheapest is slot 0 (£1), 6 cubes: slot 2 (£2), etc.
  const cheapestFilledSlot = MARKET_SLOTS - cubesInMarket;
  return marketSlotPrices[cheapestFilledSlot];
}
