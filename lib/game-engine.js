...
function actionBuildIndustry(state, player, action) {
  ...
  state.log.push(logMsg(state, `${player.username} built ${industries[industryType].name} L${level} at ${locations[location].name} (spent £${totalCost}, has £${player.money}${incChange})`));
  return { success: true };
}
